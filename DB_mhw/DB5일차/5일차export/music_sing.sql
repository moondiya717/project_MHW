...
CREATE TABLE `sing` (
  ...
  `sn_si_name` varchar(50) NOT NULL,
  PRIMARY KEY (`sn_num`),
  KEY `sn_so_num` (`sn_so_num`),
  KEY `sn_si_num` (`sn_si_num`),
  CONSTRAINT `sing_ibfk_1` FOREIGN KEY (`sn_so_num`) REFERENCES `source` (`so_num`),
  CONSTRAINT `sing_ibfk_2` FOREIGN KEY (`sn_si_num`) REFERENCES `singer` (`si_num`)
